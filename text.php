<?php
    private $_strInsertManyBase = "INSERT INTO `orderdetails`(`orderID`, `commodityID`, `orderCommodityPrice`, `orderCommodityQuantity`) VALUES";for ($i = 0; $i < count($orderDetails); $i++) {
